            ...
            <div className="blog-posts">
              <div className="text-center mb-5">
                  ...
                  <Tab.Content>
                    ...
                    {user && (
                      <Tab.Pane eventKey="myBlogs">
                        ...
                        <Tab.Container
                          id="my-blogs-sub-tabs"
                          activeKey={myBlogsSubTabKey}
                          onSelect={(k) => {
                ...
                <div className="blogs-section mt-4">
                  ...
                  {(errorBlogs || errorMyBlogs || errorMyDrafts || errorMyPending) && (
                    <ErrorMessage error={errorBlogs || errorMyBlogs || errorMyDrafts || errorMyPending} />
                  )}
