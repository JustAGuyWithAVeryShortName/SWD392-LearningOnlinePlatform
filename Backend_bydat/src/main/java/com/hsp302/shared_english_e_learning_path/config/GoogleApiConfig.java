...
public class GoogleApiConfig {
    ...
    public Credential googleCredential(
        ...
        if (in == null) {
            throw new RuntimeException("credentials.json NOT FOUND at " + credentialsFilePath);
        }

        return com.google.api.client.googleapis.auth.oauth2.GoogleCredential
                .fromStream(in, httpTransport, jsonFactory)
